...
```{r}
#Scraping our data for season 2005-2025
  ...
  top_players <- player_stats %>%
    ...
    slice_head(n = 5) %>%
    ungroup() %>%
    dplyr:: select(Player, Team, `3PM`, `3PA`) %>%
    as.data.frame()
...
top_3pt_players_df <- function(season) {
...
print(top_3pt_players_df(2005))
print(top_3pt_players_df(2006))
print(top_3pt_players_df(2007))
print(top_3pt_players_df(2008))
print(top_3pt_players_df(2009))
print(top_3pt_players_df(2010))
print(top_3pt_players_df(2011))
print(top_3pt_players_df(2012))
print(top_3pt_players_df(2013))
print(top_3pt_players_df(2014))
print(top_3pt_players_df(2015))
print(top_3pt_players_df(2016))
print(top_3pt_players_df(2017))
print(top_3pt_players_df(2018))
print(top_3pt_players_df(2019))
print(top_3pt_players_df(2020))
print(top_3pt_players_df(2021))
print(top_3pt_players_df(2022))
print(top_3pt_players_df(2023))
print(top_3pt_players_df(2024))
print(top_3pt_players_df(2025))
...
```{r}
write.csv(top_3pt_players_df(2007), "NBA_3P_2007.csv", row.names = FALSE)
write.csv(top_3pt_players_df_2009, "NBA_3P_2009.csv", row.names = FALSE)
write.csv(top_3pt_players_df_2011, "NBA_3P_2011.csv", row.names = FALSE)
write.csv(top_3pt_players_df_2013, "NBA_3P_2013.csv", row.names = FALSE)
write.csv(top_3pt_players_df_2015, "NBA_3P_2015.csv", row.names = FALSE)
write.csv(top_3pt_players_df_2017, "NBA_3P_2017.csv", row.names = FALSE)
write.csv(top_3pt_players_df_2019, "NBA_3P_2019.csv", row.names = FALSE)
write.csv(top_3pt_players_df_2021, "NBA_3P_2021.csv", row.names = FALSE)
write.csv(top_3pt_players_df_2023, "NBA_3P_2023.csv", row.names = FALSE)
```



```{r}
combined_df <- bind_rows(top_3pt_players_df(2005), top_3pt_players_df(2006), top_3pt_players_df(2007), top_3pt_players_df(2008), top_3pt_players_df(2009), top_3pt_players_df(2010), top_3pt_players_df(2011),top_3pt_players_df(2012),  top_3pt_players_df(2013), top_3pt_players_df(2014), top_3pt_players_df(2015), top_3pt_players_df(2016), top_3pt_players_df(2017), top_3pt_players_df(2018), top_3pt_players_df(2019), top_3pt_players_df(2020), top_3pt_players_df(2021), top_3pt_players_df(2022), top_3pt_players_df(2023), top_3pt_players_df(2024), top_3pt_players_df(2025))

combined_df
```

```{r}
combined_df <- bind_rows(top_3pt_players_df(2005), top_3pt_players_df(2006))
...
seasons <- seq(2005, 2025, by = 1)  # or use the exact years: c(2005, 2006, ..., 2025)
...
```{r}
ggplot(season_totals_df, aes(x = Season)) +
  geom_point(aes(y = Avg_3P_Perc, color = '3-Point Percentage')) +
  geom_smooth(aes(y = Avg_3P_Perc, color = '3-Point Percentage'), method = "lm", se = FALSE) +
...
```{r}
ggplot(nba_df, aes(Season, Three_Point_Perc)) +
  geom_point()
```
